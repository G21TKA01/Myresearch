...
from Trainer_ariel_discriminator import Trainer
from Tester_test import Tester
from data.dataset_list_ariel_discriminator import MyDataset
from torch.utils.data import DataLoader
from models import network
from models import CPS_Network_Deeplab
from models import CPS_Network
#from seg_opr.sync_bn import BatchNorm2d
...
def main(config, args):
    ...
    #model = CPS_Network_Deeplab.CPS(num_classes=config.nb_classes)
    #print(model)
    #model = network.Network(num_classes=config.nb_classes, criterion=criterion, pretrained_model="/home/taiga/ClassHyPer-master/pytorch-weight/resnet101_v1c.pth", norm_layer=nn.BatchNorm2d)
...
if __name__ == '__main__':
    config = MyConfiguration('configs/config_discriminator_2.cfg')
