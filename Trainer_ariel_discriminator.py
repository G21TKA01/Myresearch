        ...
        with open(self.log_dir + "/loss.csv", 'a') as f:
            ...
            for idx in pbar:
                ...
                if epoch > self.config.warmup_period:
                    ...
                    classes = torch.unique(ps_label_1, sorted=True)
                    nclasses = classes.shape[0]
                    if nclasses > 2:
                        mix_switch_1 = True
                    else:
                    ...
                    classes = torch.unique(ps_label_2, sorted=True)
                    nclasses = classes.shape[0]
                    if nclasses > 2:
                        mix_switch_2 = True
                    else:
                    ...
                    if mix_switch_1 == True:
                        ps_label_1_color = visualize(ps_label_1).detach()
                        ps_label_1_color = ps_label_1_color.permute(2,1,0)
                        ps_label_1_color = ps_label_1_color.unsqueeze(dim=0)

                        dis_out_1 = model_ft(ps_label_1_color).detach()
                        dis_res_1 = torch.argmax(dis_out_1)
                        print(dis_out_1)
                        print(dis_res_1)
                    ...
                    if mix_switch_2 == True:
                        ps_label_2_color = visualize(ps_label_2).detach()
                        ps_label_2_color = ps_label_2_color.permute(2,1,0)
                        ps_label_2_color = ps_label_2_color.unsqueeze(dim=0)

                        dis_out_2 = model_ft(ps_label_2_color).detach()
                        dis_res_2 = torch.argmax(dis_out_2)
                    ...
                    if store < 20 and mix_switch_1 == True:
                        ...
                        cv2.imwrite(self.log_dir + "/" + "ep" + str(epoch) + "_" + str(name_0[0][96:-4]) + "+" + str(name_1[0][96:-4]) + "_mask.png" , batch_mix_masks_numpy[0,:,:])
                        cv2.imwrite(self.log_dir + "/" + "ep" + str(epoch) + "_" + str(name_0[0][96:-4]) + "+" + str(name_1[0][96:-4]) + "_1.png" , ps_label_1_numpy[0,:,:])
                        store += 1

                    if store < 20 and mix_switch_2 == True:
                        ...
                        cv2.imwrite(self.log_dir + "/" + "ep" + str(epoch) + "_" + str(name_0[0][96:-4]) + "+" + str(name_1[0][96:-4]) + "_mask.png" , batch_mix_masks_numpy[0,:,:])
                        cv2.imwrite(self.log_dir + "/" + "ep" + str(epoch) + "_" + str(name_0[0][96:-4]) + "+" + str(name_1[0][96:-4]) + "_2.png" , ps_label_2_numpy[0,:,:])

                        store += 1
                    classmix_counter_all += 2
                    
                with autocast():
                    if epoch > self.config.warmup_period and ( mix_switch_1 == True or mix_switch_2 == True):  # warmup
                    ...
                    if mix_switch_1 == True and mix_switch_2 == True:
                        cps_loss = criterion(logits_cons_stu_1, ps_label_2) + criterion(logits_cons_stu_2, ps_label_1)
                        classmix_counter += 2

                    elif mix_switch_1 == True:
                        cps_loss = criterion(logits_cons_stu_2, ps_label_1)
                        classmix_counter += 1

                    elif mix_switch_2 == True:
                    ...
                    if epoch > self.config.warmup_period and (mix_switch_1 == True or mix_switch_2 == True):
            ...
            print("total_cps_loss:" + str(total_cps_loss) + "  total_label_loss:" + str(total_label_loss) + "  counter:" + str(classmix_counter)+ "  allcounter:" + str(classmix_counter_all))
