...
from Tester_taurus import Tester
from data.dataset_list_pisces import MyDataset
...
if __name__ == '__main__':
    config = MyConfiguration('configs/config_taurus.cfg')

    pathCkpt = r'/home/taiga/ClassHyPer-master/save/pisces/FCNs_CPS_vgg16_bn_classhyper/20221102_205324/checkpoint-best.pth'
